  ...
  constructor() {
    this.lista.push(
      new Dado(
        '0',
        'Menu planner SaaS',
        'Improving food data management to better the lives of culinary professionals',
        "In March 2023, I joined Galley, an ERP software developer for the food industry, as a UX designer. Prior to that, I contributed to the meal planning feature of McCormick's Flavor Maker app.\n\nGalley aims to enhance the lives of culinary professionals by efficiently managing their food data. A crucial daily task for these professionals is planning, which is arguably the most significant activity for maintaining efficient and profitable businesses. Galley needed to provide a SaaS platform to help chefs maximize their efficiency, saving them time on menu creation and optimizing ingredient usage.\n\nTogether with my product manager Anelise (you can view her perspective on this story as well), we conducted research and discovered that menu planning is a complex task. It requires chefs to consider multiple parameters such as budget, timeframe, frequency, allergen avoidance, dish grouping, nutritional balance, and appealing dish combinations. It takes many years to master this skill, and it remains a time-consuming task.\n\nAfter several design iterations, user testing, development, and delivery, we launched the menu planner in 2024. Here's a testimonial from one of our users:\n\n“I’m just lovin’ the new Menu Planner!!!Our #1 core value is ‘Create Menus with WOW’.  I see the Galley Menu Planner helping us to generate new, exciting menu cycles & the field take the menus from corp & customize to their communities. Specific benefits: Cost & allergen information on the menu planner, Centrally based menu plans that can be changed universally if/when needed, Ease of incorporating products, recipes & collections into menus, Flexibility in how we manage amounts to prepare (cup, small portion, large portion etc), Flexibility to create cycles of differing days, day parts, lengths etc, Flexibility to expand & contract menu content/categories to fit full service colleges as well as Monday-Friday lunch only programs, Combining program menu planning with catering, Much easier insight into how frequently users are updating/truly customizing their menu” - Coorporate Chef Denise Simmons from Meriwether-Godsey",
        2024,
        'https://firebasestorage.googleapis.com/v0/b/mb-portfolio-8e4f6.appspot.com/o/menu_planner_1.png?alt=media&token=70ba50af-fc49-4ce1-84dd-c8803d4baf3b',
        [
          'https://firebasestorage.googleapis.com/v0/b/mb-portfolio-8e4f6.appspot.com/o/menu_planner_2.png?alt=media&token=847231e1-1997-4c35-bb8b-8faf4e809d37',
          'https://firebasestorage.googleapis.com/v0/b/mb-portfolio-8e4f6.appspot.com/o/menu_planner_3.png?alt=media&token=2e53649e-514c-47dd-bae9-0309b76324f6',
          'https://firebasestorage.googleapis.com/v0/b/mb-portfolio-8e4f6.appspot.com/o/menu_planner_4.png?alt=media&token=fe0a6c24-b1d7-469f-837d-6cec9abf5645',
        ]
      )
    );
    this.lista.push(
